...
if /i "%1"=="test-ci"       set test_args=%test_args% %test_ci_args% -p tap --logfile test.tap sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential sequential&goto arg-ok
